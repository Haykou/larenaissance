...
bot.on("guildMemberAdd", member => {
    member.guild.channels.find("name", ":pencil:general").send(`Un grand Bienvenue à ${member} ;) !`)
 })
       
 bot.on("guildMemberRemove", member => {
    member.guild.channels.find("name", ":pencil:general").send(`${member} vien de quitter le serveur dommage ;(`)
 })
